...
function scaleBannerVideoSize(t) {
    ...
    $(t).each(function () {
        ...
        $(this).width(e), 1e3 > e && (o = i, n = o / t, $(this).css({
            "margin-top": 0,
            "margin-left": -(n - e) / 2 + "px"
        }), $(this).width(n).height(o)), $(".homepage-hero-module .video-container video").addClass("fadeIn animated")
    })
}
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (!function (t) {
        ...
        if (!t.jQuery) {
            ...
            i.isWindow = function (t) {
                ...
                if (n) {
                    if (r)for (; s > a && (o = i.apply(t[a], n), o !== !1); a++); else for (a in t)if (o = i.apply(t[a], n), o === !1)break
                } else if (r)for (; s > a && (o = i.call(t[a], a, t[a]), o !== !1); a++); else for (a in t)if (o = i.call(t[a], a, t[a]), o === !1)break;
                return t
            }, i.data = function (t, e, o) {
                if (void 0 === o) {
                    var a = t[i.expando], s = a && n[a];
                ...
                for ("boolean" == typeof r && (u = r, r = arguments[l] || {}, l++), "object" != typeof r && "function" !== i.type(r) && (r = {}), l === c && (r = this, l--); c > l; l++)if (null != (a = arguments[l]))for (o in a)t = r[o], n = a[o], r !== n && (u && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, s = t && i.isArray(t) ? t : []) : s = t && i.isPlainObject(t) ? t : {}, r[o] = i.extend(u, s, n)) : void 0 !== n && (r[o] = n));
                return r
        ...
        return function (t, e, i, n) {
            ...
            function l(t, i, n, o) {
                ...
                function f(e) {
                    for (var i = 0, o = 1, a = b - 1; o != a && k[o] <= e; ++o)i += w;
                    --o;
                    var s = (e - k[o]) / (k[o + 1] - k[o]), r = i + s * w, l = c(r, t, n);
                ...
                var k = x ? new Float32Array(b) : new Array(b), S = !1, P = function (e) {
            ...
            function u(t) {
                if (t) {
                    ...
                    for (var a = 0; i > a; a++)if (b.State.calls[a]) {
                        var r = b.State.calls[a], l = r[0], c = r[2], f = r[3], p = !!f, v = null;
                        ...
                        for (var g = Math.min((e - f) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                            ...
                            if (s(S)) {
                                ...
                                for (var A in C)if ("element" !== A) {
                                    ...
                                    if (1 === g) E = M.endValue; else {
                                        var O = M.endValue - M.startValue;
                                        if (E = M.startValue + O * I(g, c, O), !p && E === M.currentValue)continue
                                    }
                                    if (M.currentValue = E, "tween" === A) v = E; else {
                                        if (x.Hooks.registered[A]) {
                                            var F = x.Hooks.getRoot(A), L = s(S).rootPropertyValueCache[F];
            ...
            function h(t, e) {
                ...
                for (var i = b.State.calls[t][0], o = b.State.calls[t][1], a = b.State.calls[t][2], r = b.State.calls[t][4], l = !1, c = 0, u = i.length; u > c; c++) {
                    ...
                    if (e || a.loop || ("none" === a.display && x.setPropertyValue(h, "display", a.display), "hidden" === a.visibility && x.setPropertyValue(h, "visibility", a.visibility)), a.loop !== !0 && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && s(h)) {
                        ...
                        d.each(x.Lists.transforms3D, function (t, e) {
                            var i = /^scale/.test(e) ? 1 : 0, o = s(h).transformCache[e];
                ...
                b.State.calls[t] = !1;
                for (var m = 0, v = b.State.calls.length; v > m; m++)if (b.State.calls[m] !== !1) {
                    l = !0;
                    break
                }
            ...
            var w = function () {
                ...
                function i(i, n) {
                    var o = {
                        dx: i.v,
                        dv: t(i)
                    }, a = e(i, .5 * n, o), s = e(i, .5 * n, a), r = e(i, n, s), l = 1 / 6 * (o.dx + 2 * (a.dx + s.dx) + r.dx), c = 1 / 6 * (o.dv + 2 * (a.dv + s.dv) + r.dv);
                    return i.x = i.x + l * n, i.v = i.v + c * n, i
                }

                return function n(t, e, o) {
                    var a, s, r, l = {x: -1, v: 0, tension: null, friction: null}, c = [0], u = 0, h = 1e-4, d = .016;
            ...
            var x = b.CSS = {
                        ...
                        for (var t = 0; t < x.Lists.colors.length; t++)!function () {
                            ...
                            x.Normalizations.registered[e] = function (t, i, o) {
                                switch (t) {
                                    ...
                                    case"extract":
                                        var a;
                                        if (x.RegEx.wrappedValueAlreadyExtracted.test(o)) a = o; else {
                                            var s, r = {
                                                black: "rgb(0, 0, 0)",
                                                blue: "rgb(0, 0, 255)",
                ...
                getPropertyValue: function (t, i, o, a) {
                    ...
                    if (!/^[\d-]/.test(l))if (s(t) && s(t).isSVG && x.Names.SVGAttribute(i))if (/^(height|width)$/i.test(i))try {
                        l = t.getBBox()[i]
                    } catch (m) {
                        l = 0
                    } else l = t.getAttribute(i); else l = r(t, x.Names.prefixCheck(i)[0]);
                    return x.Values.isCSSNullValue(l) && (l = 0), b.debug >= 2 && console.log("Get " + i + ": " + l), l
                },
                setPropertyValue: function (t, i, n, o, a) {
                    var r = i;
                    if ("scroll" === i) a.container ? a.container["scroll" + a.direction] = n : "Left" === a.direction ? e.scrollTo(n, a.alternateValue) : e.scrollTo(a.alternateValue, n); else if (x.Normalizations.registered[i] && "transform" === x.Normalizations.registered[i]("name", t)) x.Normalizations.registered[i]("inject", t, n), r = "transform", n = s(t).transformCache[i]; else {
                        if (x.Hooks.registered[i]) {
            ...
            var C = function () {
                ...
                function o() {
                    function t(t) {
                        ...
                        function g() {
                            ...
                            }, n = t.position === D.lastPosition && t.myParent === D.lastParent, o = t.fontSize === D.lastFontSize;
                            D.lastParent = t.myParent, D.lastPosition = t.position, D.lastFontSize = t.fontSize;
                            var r = 100, l = {};
                            if (o && n) l.emToPx = D.lastEmToPx, l.percentToPxWidth = D.lastPercentToPxWidth, l.percentToPxHeight = D.lastPercentToPxHeight; else {
                        ...
                        if ("scroll" === E) {
                            ...
                            r.container ? m.isWrapped(r.container) || m.isNode(r.container) ? (r.container = r.container[0] || r.container, C = r.container["scroll" + M], T = C + d(a).position()[M.toLowerCase()] + I) : r.container = null : (C = b.State.scrollAnchor[b.State["scrollProperty" + M]], P = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === M ? "Top" : "Left")]], T = d(a).offset()[M.toLowerCase()] + I), l = {
                                scroll: {
                                    ...
                                    unitType: "",
                                    easing: r.easing,
                                    scrollData: {container: r.container, direction: M, alternateValue: P}
                                }, element: a
                            ...
                            for (var z in v) {
                                var _ = h(v[z]), V = _[0], W = _[1], H = _[2];
                                z = x.Names.camelCase(z);
                                var N = x.Hooks.getRoot(z), B = !1;
                                if (s(a).isSVG || "tween" === N || x.Names.prefixCheck(N)[1] !== !1 || x.Normalizations.registered[N] !== n) {
                                    ...
                                    if (j = f(z, H), H = j[0], q = j[1], j = f(z, V), V = j[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return Y = e, ""
                                        }), $ = j[1], H = parseFloat(H) || 0, V = parseFloat(V) || 0, "%" === $ && (/^(fontSize|lineHeight)$/.test(z) ? (V /= 100, $ = "em") : /^scale/.test(z) ? (V /= 100, $ = "") : /(Red|Green|Blue)$/i.test(z) && (V = V / 100 * 255, $ = "")), /[\/*]/.test(Y)) $ = q; else if (q !== $ && 0 !== H)if (0 === V) $ = q; else {
                                        o = o || g();
                ...
                if (m.isWrapped(this) ? (r = !1, f = 0, p = this, l = this) : (r = !0, f = 1, p = w ? arguments[0].elements || arguments[0].e : arguments[0]), p = a(p)) {
                        ...
                        default:
                            if (!d.isPlainObject(v) || m.isEmptyObject(v)) {
                                if (m.isString(v) && b.Redirects[v]) {
                                    var I = d.extend({}, y), O = I.duration, F = I.delay || 0;
                                    return I.backwards === !0 && (p = d.extend(!0, [], p).reverse()), d.each(p, function (t, e) {
                                        parseFloat(I.stagger) ? I.delay = F + parseFloat(I.stagger) * t : m.isFunction(I.stagger) && (I.delay = F + I.stagger.call(e, t, k)), I.drag && (I.duration = parseFloat(O) || (/^(callout|transition)/.test(v) ? 1e3 : g), I.duration = Math.max(I.duration * (I.backwards ? 1 - t / k : (t + 1) / k), .75 * I.duration, 200)), b.Redirects[v].call(e, e, I || {}, t, k, p, A.promise ? A : n)
                                    }), t()
                                }
                    ...
                    if (I.loop = parseInt(I.loop), z = 2 * I.loop - 1, I.loop)for (var _ = 0; z > _; _++) {
    ...
    var t = this, e = t.Chart, i = function (t) {
        ...
        }, o = this.width = i(t.canvas, "Width") || t.canvas.width, a = this.height = i(t.canvas, "Height") || t.canvas.height;
    ...
    var n = i.helpers = {}, o = n.each = function (t, e, i) {
        ...
        return 0 > i && 0 > n && (a += 2 * Math.PI), {angle: a, distance: o}
    }, n.aliasPixel = function (t) {
        return t % 2 === 0 ? 0 : .5
    }), T = (n.splineCurve = function (t, e, i, n) {
        var o = Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2)), a = Math.sqrt(Math.pow(i.x - e.x, 2) + Math.pow(i.y - e.y, 2)), s = n * o / (o + a), r = n * a / (o + a);
        return {
        ...
        for (var d = Math.abs(h - u), f = T(d), p = Math.ceil(h / (1 * Math.pow(10, f))) * Math.pow(10, f), m = n ? 0 : Math.floor(u / (1 * Math.pow(10, f))) * Math.pow(10, f), v = p - m, g = Math.pow(10, f), w = Math.round(v / g); (w > r || r > 2 * w) && !l;)if (w > r) g *= 2, w = Math.round(v / g), w % 1 !== 0 && (l = !0); else if (a && f >= 0) {
            if (g / 2 % 1 !== 0)break;
            g /= 2, w = Math.round(v / g)
        } else g /= 2, w = Math.round(v / g);
        return l && (w = s, g = v / w), {steps: w, stepValue: g, min: m, max: m + w * g}
        ...
        var s = 0, r = I[i] || I.linear, l = function () {
            s++;
            var i = s / e, c = r(i);
    ...
    i.instances = {}, i.Type = function (t, e, n) {
        ...
        initialize: function () {
            ...
            this.stop();
            var e = this.chart.canvas, i = W(this.chart.canvas), n = this.options.maintainAspectRatio ? i / this.chart.aspectRatio : H(this.chart.canvas);
            ...
            if (t && this.reflow(), this.options.animation && !t) {
                ...
                e.numSteps = this.options.animationSteps, e.easing = this.options.animationEasing, e.render = function (t, e) {
                    var i = n.easingEffects[e.easing], o = e.currentStep / e.numSteps, a = i(o);
        ...
        inRange: function (t, e) {
            var i = n.getAngleFromPoint(this, {
                x: t,
                y: e
            }), o = i.angle % (2 * Math.PI), a = (2 * Math.PI + this.startAngle) % (2 * Math.PI), s = (2 * Math.PI + this.endAngle) % (2 * Math.PI) || 360, r = a > s ? s >= o || o >= a : o >= a && s >= o, l = i.distance >= this.innerRadius && i.distance <= this.outerRadius;
            return r && l
        }, tooltipPosition: function () {
        ...
        draw: function () {
            var t = this.ctx, e = this.width / 2, i = this.x - e, n = this.x + e, o = this.base - (this.base - this.y), a = this.strokeWidth / 2;
        ...
        draw: function () {
            ...
            var e = this.caretPadding = 2, i = t.measureText(this.text).width + 2 * this.xPadding, n = this.fontSize + 2 * this.yPadding, o = n + this.caretHeight + e;
            ...
            if (t.fillStyle = this.fillColor, this.custom) this.custom(this); else {
                ...
                X(t, a, s, i, n, this.cornerRadius), t.fill(), t.fillStyle = this.textColor, t.textAlign = "center", t.textBaseline = "middle", t.fillText(this.text, a + i / 2, s + n / 2)
            }
        }
        ...
        initialize: function () {
            ...
            var t = this.ctx.measureText(this.title).width, e = Y(this.ctx, this.font, this.labels) + this.fontSize + 3, i = y([e, t]);
        ...
        initialize: function () {
            ...
            var i = (this.xLabelRotation > 0, this.width - (this.xScalePaddingLeft + this.xScalePaddingRight)), n = i / Math.max(this.valuesCount - (this.offsetGridLines ? 0 : 1), 1), o = n * t + this.xScalePaddingLeft;
            ...
            this.display && (t.fillStyle = this.textColor, t.font = this.font, o(this.yLabels, function (o, a) {
                var s = this.endPoint - e * a, r = Math.round(s), l = this.showHorizontalLines;
                ...
                if (o(this.yLabels, function (e, i) {
                    ...
                    for (var e = this.valuesCount - 1; e >= 0; e--) {
                        ...
                        if (this.angleLineWidth > 0 && (i = this.calculateCenterOffset(this.max), n = this.getPointPosition(e, i), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(n.x, n.y), t.stroke(), t.closePath()), this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
                            ...
                            var a = this.getPointPosition(0 === e ? this.valuesCount - 1 : e - 1, i), s = this.getPointPosition(e === this.valuesCount - 1 ? 0 : e + 1, i), r = {
                                x: (a.x + n.x) / 2,
                                y: (a.y + n.y) / 2
                        ...
                        var u = this.labels.length, h = this.labels.length / 2, d = h / 2, f = d > e || e > u - d, p = e === d || e === u - d;
        ...
        frameDuration: 17, animations: [], dropFrames: 0, addAnimation: function (t, e) {
            ...
            var o = Date.now(), a = o - t - this.frameDuration, s = a / this.frameDuration;
        ...
        name: "Bar", defaults: n, initialize: function (t) {
            ...
            this.ScaleClass = e.Scale.extend({
                offsetGridLines: !0, calculateBarX: function (t, e, i) {
                    var o = this.calculateBaseWidth(), a = this.calculateX(i) - o / 2, s = this.calculateBarWidth(t);
            ...
            for (var a, e = [], n = i.getRelativePosition(t), o = function (t) {
                e.push(t.bars[a])
            }, s = 0; s < this.datasets.length; s++)for (a = 0; a < this.datasets[s].bars.length; a++)if (this.datasets[s].bars[a].inRange(n.x, n.y))return i.each(this.datasets, o), e;
            return e
    ...
    e.Type.extend({
        name: "Line", defaults: n, initialize: function (t) {
            ...
            var e = t || 1;
            this.clear();
            var n = this.chart.ctx, o = function (t) {
                return null !== t.value
            }, a = function (t, e, n) {
    ...
    e.Type.extend({
        ...
        getPointsAtEvent: function (t) {
            ...
            }, e), o = 2 * Math.PI / this.scale.valuesCount, a = Math.round((n.angle - 1.5 * Math.PI) / o), s = [];
    ...
    function f(t, e, i) {
        if (i) {
            ...
            var n = i.getAttribute("data-x"), o = i.getAttribute("data-y"), a = i.getAttribute("data-scale"), s = i.getAttribute("data-translate"), r = Date.now() - Number(i.getAttribute("data-hold")), l = 350 - r;
    ...
    return t.init = function (t) {
        ...
        t = l(t);
        var i = t.length;
        if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, i)for (var n, o, a, s = {}, r = 0, u = {
            type: "mousedown",
            button: 1
        }, d = function (t, e) {
            return function () {
        ...
        t = l(t);
        for (var e = {type: "mouseup", button: 1}, i = 0, n = t.length; n > i; i++)h.hide(e, t[i])
    ...
    t(["jquery"], function (t) {
        return function () {
            ...
            function w(i) {
                ...
                function y() {
                    c.hover(F, O), !o.onclick && o.tapToDismiss && c.click(I), o.closeButton && f && f.click(function (t) {
                ...
                function w() {
                    c.hide(), c[o.showMethod]({
                        ...
                        easing: o.showEasing,
                        complete: o.onShown
                    }), o.timeOut > 0 && (r = setTimeout(I, o.timeOut), p.maxHideTime = parseFloat(o.timeOut), p.hideEta = (new Date).getTime() + p.maxHideTime, o.progressBar && (p.intervalId = setInterval(L, 10)))
                }
                ...
                function P() {
                    i.title && (u.append(o.escapeHtml ? v(i.title) : i.title).addClass(o.titleClass), c.append(u))
                }

                function T() {
                    i.message && (h.append(o.escapeHtml ? v(i.message) : i.message).addClass(o.messageClass), c.append(h))
                }
                ...
                function I(e) {
                    var i = e && o.closeMethod !== !1 ? o.closeMethod : o.hideMethod, n = e && o.closeDuration !== !1 ? o.closeDuration : o.hideDuration, a = e && o.closeEasing !== !1 ? o.closeEasing : o.hideEasing;
                    return !t(":focus", c).length || e ? (clearTimeout(p.intervalId), c[i]({
                            duration: n,
                            easing: a,
                            complete: function () {
                                C(c), o.onHidden && "hidden" !== m.state && o.onHidden(), m.state = "hidden", m.endTime = new Date, b(m)
                            }
                        })) : void 0
                }
                ...
                function F() {
                    clearTimeout(r), p.hideEta = 0, c.stop(!0, !0)[o.showMethod]({
                        duration: o.showDuration,
                        easing: o.showEasing
                    })
                }
    ...
    t.fn.scrollTo = function (e) {
        ...
        this.each(function () {
            ...
            function r() {
                s(), a.addClass("active"), o.constrain_width === !0 && a.css("width", n.outerWidth());
                var e = 0;
                o.belowOrigin === !0 && (e = n.height());
                var i = n.offset().left, r = 0, l = o.gutter;
                ...
                }).animate({opacity: 1}, {queue: !1, duration: o.inDuration, easing: "easeOutSine"})
            }

            function l() {
                a.fadeOut(o.outDuration), a.removeClass("active")
            }

            var n = t(this), o = t.extend({}, i, e), a = t("#" + n.attr("data-activates"));
    ...
    t.fn.extend({
        openModal: function (i) {
            ...
            var o = {
                ...
                dismissible: !0,
                starting_top: "4%"
            }, a = n(), s = t(this), r = t('<div class="lean-overlay"></div>'), l = ++e;
            r.attr("id", a).css("z-index", 1e3 + 2 * l), s.data("overlay-id", a).css("z-index", 1e3 + 2 * l + 1), t("body").append(r), i = t.extend(o, i), i.dismissible && (r.click(function () {
                s.closeModal(i)
            }), t(document).on("keyup.leanModal" + a, function (t) {
                27 === t.keyCode && s.closeModal(i)
            })), s.find(".modal-close").on("click.close", function (t) {
                s.closeModal(i)
            }), r.css({display: "block", opacity: 0}), s.css({
                display: "block",
                opacity: 0
            }), r.velocity({opacity: i.opacity}, {
        ...
        closeModal: function (i) {
            var n = {out_duration: 250, complete: void 0}, o = t(this), a = o.data("overlay-id"), s = t("#" + a);
            i = t.extend(n, i), t("body").css("overflow", ""), o.find(".modal-close").off("click.close"), t(document).off("keyup.leanModal" + a), s.velocity({opacity: 0}, {
    ...
    function ot(t, e, i) {
        var n = i.pointers.length, o = i.changedPointers.length, a = e & B && n - o === 0, s = e & ($ | q) && n - o === 0;
    ...
    function at(t, e) {
        ...
        var a = i.firstInput, s = i.firstMultiple, r = s ? s.center : a.center, u = e.center = ct(n);
    ...
    function rt(t, e) {
        ...
        if (e.eventType != q && (o > N || i.velocity === n)) {
            var u = e.deltaX - i.deltaX, h = e.deltaY - i.deltaY, d = ut(o, u, h);
            s = d.x, r = d.y, a = l(d.x) > l(d.y) ? d.x : d.y, c = ht(u, h), t.lastInterval = e
        } else a = i.velocity, s = i.velocityX, r = i.velocityY, c = i.direction;
    ...
    function St() {
        this.evEl = Ct, this.evWin = kt, it.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
    }
    ...
    function Ft() {
        this.evTarget = Ot, this.targetIds = {}, it.apply(this, arguments)
    }
    ...
    function Lt(t, e) {
        ...
        if (a = i.filter(function (t) {
                return k(t.target, l)
            }), e === B)for (o = 0; o < a.length;)n[a[o].identifier] = !0, o++;
    ...
    function _t(t, e) {
        t & B ? (this.primaryTouch = e.changedPointers[0].identifier, Vt.call(this, e)) : t & ($ | q) && Vt.call(this, e)
    }
    ...
    function Wt(t) {
        for (var e = t.srcEvent.clientX, i = t.srcEvent.clientY, n = 0; n < this.lastTouches.length; n++) {
            var o = this.lastTouches[n], a = Math.abs(e - o.x), s = Math.abs(i - o.y);
    ...
    function ae(t) {
        this.options = p({}, this.defaults, t || {}), this.id = O(), this.manager = null, this.options.enable = w(this.options.enable, !0), this.state = Kt, this.simultaneous = {}, this.requireFail = []
    }
    ...
    function be(t, e) {
        this.options = p({}, ve.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = nt(this), this.touchAction = new Zt(this, this.options.touchAction), we(this, !0), d(this.options.recognizers, function (t) {
    ...
    var m = f(function (t, e, i) {
        ...
        return t
    }, "extend", "Use `assign`."), v = f(function (t, e) {
        return m(t, e, !0)
    }, "merge", "Use `assign`."), I = 1, L = /mobile|tablet|ip(ad|hone|od)|android/i, D = "ontouchstart" in t, R = M(t, "PointerEvent") !== n, z = D && L.test(navigator.userAgent), _ = "touch", V = "pen", W = "mouse", H = "kinect", N = 25, B = 1, j = 2, $ = 4, q = 8, Y = 1, X = 2, Q = 4, Z = 8, G = 16, U = X | Q, K = Z | G, J = U | K, tt = ["x", "y"], et = ["clientX", "clientY"];
    it.prototype = {
        handler: function () {
        }, init: function () {
            this.evEl && x(this.element, this.evEl, this.domHandler), this.evTarget && x(this.target, this.evTarget, this.domHandler), this.evWin && x(F(this.element), this.evWin, this.domHandler)
        }, destroy: function () {
            this.evEl && C(this.element, this.evEl, this.domHandler), this.evTarget && C(this.target, this.evTarget, this.domHandler), this.evWin && C(F(this.element), this.evWin, this.domHandler)
        }
    };
    var vt = {mousedown: B, mousemove: j, mouseup: $}, gt = "mousedown", yt = "mousemove mouseup";
    g(bt, it, {
        handler: function (t) {
            var e = vt[t.type];
            e & B && 0 === t.button && (this.pressed = !0), e & j && 1 !== t.which && (e = $), this.pressed && (e & $ && (this.pressed = !1), this.callback(this.manager, e, {
                pointers: [t],
                changedPointers: [t],
                pointerType: W,
                srcEvent: t
    ...
    var wt = {pointerdown: B, pointermove: j, pointerup: $, pointercancel: q, pointerout: q}, xt = {
        2: _,
        3: V,
        4: W,
        5: H
    }, Ct = "pointerdown", kt = "pointermove pointerup pointercancel";
    t.MSPointerEvent && !t.PointerEvent && (Ct = "MSPointerDown", kt = "MSPointerMove MSPointerUp MSPointerCancel"), g(St, it, {
        handler: function (t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = wt[n], a = xt[t.pointerType] || t.pointerType, s = a == _, r = T(e, t.pointerId, "pointerId");
            o & B && (0 === t.button || s) ? 0 > r && (e.push(t), r = e.length - 1) : o & ($ | q) && (i = !0), 0 > r || (e[r] = t, this.callback(this.manager, o, {
                pointers: e,
                changedPointers: [t],
                pointerType: a,
                srcEvent: t
    ...
    g(Ft, it, {
        handler: function (t) {
            var e = It[t.type], i = Lt.call(this, t, e);
    ...
    g(zt, it, {
        handler: function (t, e, i) {
            var n = i.pointerType == _, o = i.pointerType == W;
            if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                if (n) _t.call(this, e, i); else if (o && Wt.call(this, i))return;
                this.callback(t, e, i)
            }
        }, destroy: function () {
    ...
    var Ht = M(a.style, "touchAction"), Nt = Ht !== n, Bt = "compute", jt = "auto", $t = "manipulation", qt = "none", Yt = "pan-x", Xt = "pan-y", Qt = Ut();
    Zt.prototype = {
        set: function (t) {
            t == Bt && (t = this.compute()), Nt && this.manager.element.style && Qt[t] && (this.manager.element.style[Ht] = t), this.actions = t.toLowerCase().trim()
        }, update: function () {
            ...
            var n = this.actions, o = S(n, qt) && !Qt[qt], a = S(n, Xt) && !Qt[Xt], s = S(n, Yt) && !Qt[Yt];
            if (o) {
    ...
    var Kt = 1, Jt = 2, te = 4, ee = 8, ie = ee, ne = 16, oe = 32;
    ae.prototype = {
        ...
        defaults: {pointers: 1}, attrTest: function (t) {
            ...
            var e = this.state, i = t.eventType, n = e & (Jt | te), o = this.attrTest(t);
            return n && (i & q || !o) ? e | ne : n || o ? i & $ ? e | ee : e & Jt ? e | te : Jt : oe
        }
    }), g(ue, ce, {
        defaults: {event: "pan", threshold: 10, pointers: 1, direction: J}, getTouchAction: function () {
            var t = this.options.direction, e = [];
            return t & U && e.push(Xt), t & K && e.push(Yt), e
        }, directionTest: function (t) {
            var e = this.options, i = !0, n = t.distance, o = t.direction, a = t.deltaX, s = t.deltaY;
            return o & e.direction || (e.direction & U ? (o = 0 === a ? Y : 0 > a ? X : Q, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === s ? Y : 0 > s ? Z : G, i = s != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
        }, attrTest: function (t) {
        ...
        defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
            ...
            if (this._input = t, !n || !i || t.eventType & ($ | q) && !o) this.reset(); else if (t.eventType & B) this.reset(), this._timer = u(function () {
                this.state = ie, this.tryEmit()
            }, e.time, this); else if (t.eventType & $)return ie;
            return oe
        }, reset: function () {
        ...
        defaults: {event: "swipe", threshold: 10, velocity: .3, direction: U | K, pointers: 1},
        getTouchAction: function () {
        ...
        defaults: {
            ...
            if (n && o && i) {
                ...
                var a = this.pTime ? t.timeStamp - this.pTime < e.interval : !0, s = !this.pCenter || dt(this.pCenter, t.center) < e.posThreshold;
                this.pTime = t.timeStamp, this.pCenter = t.center, s && a ? this.count += 1 : this.count = 1, this._input = t;
                var r = this.count % e.taps;
                if (0 === r)return this.hasRequireFailures() ? (this._timer = u(function () {
                        this.state = ie, this.tryEmit()
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[fe, {enable: !1}], [he, {enable: !1}, ["rotate"]], [pe, {direction: U}], [ue, {direction: U}, ["swipe"]], [me], [me, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [de]],
        cssProps: {
    ...
    var e = {
        init: function (e) {
            ...
            e = t.extend(i, e), t(this).each(function () {
                function a(i) {
                    s = !1, r = !1, t("body").css("overflow", ""), t("#sidenav-overlay").velocity({opacity: 0}, {
                        duration: 200,
                        queue: !1,
                        easing: "easeOutQuad",
                        complete: function () {
                            ...
                            right: "",
                            left: "0"
                        }), n.velocity({left: -1 * (e.menuWidth + 10)}, {
                            duration: 200,
                            queue: !1,
                            easing: "easeOutCubic",
                            complete: function () {
                            ...
                            right: "0",
                            left: ""
                        }), n.velocity({right: -1 * (e.menuWidth + 10)}, {
                            duration: 200,
                            queue: !1,
                            easing: "easeOutCubic",
                            complete: function () {
                ...
                t("body").append(o), "left" == e.edge ? (n.css("left", -1 * (e.menuWidth + 10)), o.css({left: 0})) : (n.addClass("right-aligned").css("right", -1 * (e.menuWidth + 10)).css("left", ""), o.css({right: 0})), n.hasClass("fixed") && window.innerWidth > 992 && n.css("left", 0), n.hasClass("fixed") && t(window).resize(function () {
                    window.innerWidth > 992 ? 0 !== t("#sidenav-overlay").css("opacity") && r ? a(!0) : (n.removeAttr("style"), n.css("width", e.menuWidth)) : r === !1 && ("left" === e.edge ? n.css("left", -1 * (e.menuWidth + 10)) : n.css("right", -1 * (e.menuWidth + 10)))
                ...
                o.on("click", function () {
                    ...
                    if ("touch" == i.gesture.pointerType) {
                        ...
                        if ("left" === e.edge && (s > e.menuWidth ? s = e.menuWidth : 0 > s && (s = 0)), "left" === e.edge) s < e.menuWidth / 2 ? r = !1 : s >= e.menuWidth / 2 && (r = !0), n.css("left", s - e.menuWidth); else {
                            s < window.innerWidth - e.menuWidth / 2 ? r = !0 : s >= window.innerWidth - e.menuWidth / 2 && (r = !1);
                            var h = -1 * (s - e.menuWidth / 2);
                            h > 0 && (h = 0), n.css("right", h)
                        }
                        var d;
                        "left" === e.edge ? (d = s / e.menuWidth, t("#sidenav-overlay").velocity({opacity: d}, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (d = Math.abs((s - window.innerWidth) / e.menuWidth), t("#sidenav-overlay").velocity({opacity: d}, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            }))
                    ...
                    if ("touch" == i.gesture.pointerType) {
                        ...
                        s = !1, "left" === e.edge ? r && .3 >= a || -.5 > a ? (n.velocity({left: 0}, {
                                    duration: 300,
                                    queue: !1,
                                    easing: "easeOutQuad"
                                    ...
                                    right: 0,
                                    left: ""
                                })) : (!r || a > .3) && (t("body").css("overflow", ""), n.velocity({left: -1 * (e.menuWidth + 10)}, {
                                    duration: 200,
                                    queue: !1,
                                    easing: "easeOutQuad"
                                    ...
                                    right: "",
                                    left: 0
                                })) : (!r || -.3 > a) && (t("body").css("overflow", ""), n.velocity({right: -1 * (e.menuWidth + 10)}, {
                                    duration: 200,
                                    queue: !1,
                                    easing: "easeOutQuad"
                                }), t("#sidenav-overlay").velocity({opacity: 0}, {
                    ...
                    if (r === !0) r = !1, s = !1, a(); else {
                        t("body").css("overflow", "hidden"), t("body").append(o), "left" === e.edge ? (o.css({
                                ...
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (o.css({width: "50%", right: "", left: 0}), n.velocity({right: 0}, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad"
                            }), n.css("left", ""));
                        ...
                        i.css("opacity", 0).click(function () {
                            r = !1, s = !1, a(), i.velocity({opacity: 0}, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad",
                                complete: function () {
    ...
    t.fn.collapsible = function (e) {
        ...
        return e = t.extend(i, e), this.each(function () {
            ...
            var i = t(this), n = t(this).find("> li > .collapsible-header"), o = i.data("collapsible");
    ...
    var e = function (t, e) {
        ...
        this.getCanvas = function () {
            ...
            e.onStart(t, i);
            var o = function () {
                var a = Math.min(Date.now() - n, e.animate.duration), s = e.easing(this, a, t, i - t, e.animate.duration);
                this.draw(s), e.onStep(t, i, s), a >= e.animate.duration ? e.onStop(t, i) : c(o)
            }.bind(this);
            c(o)
        }.bind(this)
    }, i = function (t, i) {
    ...
    t(document).ready(function () {
        ...
        t(this).each(function () {
            ...
            if (!n.hasClass("browser-default")) {
                ...
                var l = t('<ul id="select-options-' + s + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>'), c = n.children("option, optgroup"), u = [], h = !1, d = n.find("option:selected").html() || n.find("option:first").html() || "", f = function (e, i, n) {
                    var o = i.is(":disabled") ? "disabled " : "", a = i.data("icon"), s = i.attr("class");
                    if (a) {
                        var r = "";
                        return s && (r = ' class="' + s + '"'), "multiple" === n ? l.append(t('<li class="' + o + '"><img src="' + a + '"' + r + '><span><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : l.append(t('<li class="' + o + '"><img src="' + a + '"' + r + "><span>" + i.html() + "</span></li>")), !0
                    }
                ...
                c.length && c.each(function () {
                    if (t(this).is("option")) o ? f(n, t(this), "multiple") : f(n, t(this)); else if (t(this).is("optgroup")) {
                    ...
                    t(this).click(function (s) {
                        if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                            ...
                            o ? (t('input[type="checkbox"]', this).prop("checked", function (t, e) {
                                    return !e
                                }), r = i(u, t(this).index(), n), v.trigger("focus")) : (l.find("li").removeClass("active"), t(this).toggleClass("active"), v.val(t(this).text())), activateOption(l, t(this)), n.find("option").eq(a).prop("selected", r), n.trigger("change"), "undefined" != typeof e && e()
                        }
                        s.stopPropagation()
                    })
                }), n.wrap(r);
                ...
                var m = d.replace(/"/g, "&quot;"), v = t('<input type="text" class="select-dropdown" readonly="true" ' + (n.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + s + '" value="' + m + '"/>');
                ...
                var g = [], y = function (e) {
                    ...
                    if (13 != e.which || l.is(":visible")) {
                        ...
                        if (i && -1 === n.indexOf(e.which)) {
                            g.push(i);
                            var a = g.join(""), s = l.find("li").filter(function () {
    ...
    function a(e, c, u, d) {
        ...
        function x() {
            ...
            }).on("keydown." + p.id, A), l(e, {haspopup: !0, expanded: !1, readonly: !1, owns: e.id + "_root"})
        }
        ...
        function k() {
            b.$holder.on({
                keydown: A, "focus.toOpen": T, blur: function () {
                ...
                var e = t(this), i = e.data(), n = e.hasClass(v.navDisabled) || e.hasClass(v.disabled), o = h();
        ...
        if (!e)return a;
        var f = !1, p = {id: e.id || "P" + Math.abs(~~(Math.random() * new Date))}, m = u ? t.extend(!0, {}, u.defaults, d) : d || {}, v = t.extend({}, a.klasses(), m.klass), g = t(e), y = function () {
            return this.start()
        }, b = y.prototype = {
            constructor: y, $node: g, start: function () {
                return p && p.start ? b : (p.methods = {}, p.start = !0, p.open = !1, p.type = e.type, e.autofocus = e == h(), e.readOnly = !m.editable, e.id = e.id || p.id, "text" != e.type && (e.type = "text"), b.component = new u(b, m), b.$root = t('<div class="' + v.picker + '" id="' + e.id + '_root" />'), C(), b.$holder = t(w()).appendTo(b.$root), k(), m.formatSubmit && S(), x(), m.containerHidden ? t(m.containerHidden).append(b._hidden) : g.after(b._hidden), m.container ? t(m.container).append(b.$root) : g.after(b.$root), b.on({
                        ...
                        close: m.onClose,
                        set: m.onSet
                    }), f = s(b.$holder[0]), e.autofocus && b.open(), b.trigger("start").trigger("render"))
            }, render: function (e) {
                return e ? (b.$holder = t(w()), k(), b.$root.html(b.$holder)) : b.$root.find("." + v.box).html(b.component.nodes(p.open)), b.trigger("render")
            }, stop: function () {
                ...
                return p.open ? b : (g.addClass(v.active), l(e, "expanded", !0), setTimeout(function () {
                    ...
                    }, 0), o !== !1 && (p.open = !0, f && n.css("overflow", "hidden").css("padding-right", "+=" + r()), P(), i.on("click." + p.id + " focusin." + p.id, function (t) {
                        var i = t.target;
                        i != e && i != document && 3 != t.which && b.close(i === b.$holder[0])
                    }).on("keydown." + p.id, function (e) {
                        var i = e.keyCode, n = b.component.key[i], o = e.target;
                        27 == i ? b.close(!0) : o != b.$holder[0] || !n && 13 != i ? t.contains(b.$root[0], o) && 13 == i && (e.preventDefault(), o.click()) : (e.preventDefault(), n ? a._.trigger(b.component.key.go, b, [a._.trigger(n)]) : b.$root.find("." + v.highlighted).hasClass(v.disabled) || (b.set("select", b.component.item.highlight), m.closeOnSelect && b.close(!0)))
                    })), b.trigger("open"))
            }, close: function (t) {
                ...
                }, 0), p.open ? (p.open = !1, f && n.css("overflow", "").css("padding-right", "-=" + r()), i.off("." + p.id), b.trigger("close")) : b
            }, clear: function (t) {
    ...
    function r() {
        ...
        var a = t('<div style="width:100%" />').appendTo(i), s = a[0].offsetWidth;
        return i.remove(), o - s
    }
    ...
    function a(t, e) {
        var i = this, n = t.$node[0], o = n.value, a = t.$node.data("value"), s = a || o, r = a ? e.formatSubmit : e.format, l = function () {
    ...
    a.prototype.set = function (t, e, i) {
        ...
        var i = this;
        return e ? "string" == typeof e ? e = i.parse(t, e) : o.isInteger(e) && (e = i.now(t, e, {rel: e})) : e = "min" == t ? -(1 / 0) : 1 / 0, e
        ...
        if ((!n || !n.nav && !n.defaultValue) && (!l && a.disabled(i) || l && a.disabled(i) && (m || c || u) || !l && (i.pick <= h.pick || i.pick >= d.pick)))for (l && !m && (!u && r > 0 || !c && 0 > r) && (r *= -1); a.disabled(i) && (Math.abs(r) > 1 && (i.month < s.month || i.month > s.month) && (i = s, r = r > 0 ? 1 : -1), i.pick <= h.pick ? (f = !0, r = 1, i = a.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : -1)])) : i.pick >= d.pick && (p = !0, r = -1, i = a.create([d.year, d.month, d.date + (i.pick === d.pick ? 0 : 1)])), !f || !p);)i = a.create([i.year, i.month, i.date + r]);
        return i
        ...
        return e && "string" == typeof e ? (i && i.format || (i = i || {}, i.format = n.settings.format), n.formats.toArray(i.format).map(function (t) {
                var i = n.formats[t], s = i ? o.trigger(i, n, [e, a]) : t.replace(/^!/, "").length;
        ...
        return "flip" == i ? n.flipEnable() : i === !1 ? (n.flipEnable(1), a = []) : i === !0 ? (n.flipEnable(-1), a = []) : i.map(function (t) {
                        for (var i, s = 0; s < a.length; s += 1)if (n.isDateExact(t, a[s])) {
                            i = !0;
                            break
                        }
        ...
        var n = this, a = n.item.disable, s = a.length;
        return "flip" == i ? n.flipEnable() : i === !0 ? (n.flipEnable(1), a = []) : i === !1 ? (n.flipEnable(-1), a = []) : i.map(function (t) {
                        ...
                        if (i)for (l = 0; s > l; l += 1)if (n.isDateExact(a[l], t)) {
                            a[l] = null;
                            break
                        }
                        if (c)for (l = 0; s > l; l += 1)if (n.isDateOverlap(a[l], t)) {
                            a[l] = null;
                            break
                        }
                        i && a.push(i)
        ...
        var e = this, a = e.settings, s = e.item, r = s.now, l = s.select, c = s.highlight, u = s.view, h = s.disable, d = s.min, f = s.max, p = function (t, e) {
        ...
        }((a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(0), a.weekdaysFull.slice(0)), m = function (t) {
            ...
            return a.selectMonths ? o.node("select", o.group({
                ...
                }), a.klass.selectMonth, (t ? "" : "disabled") + " " + o.ariaAttr({controls: e.$node[0].id + "_table"}) + ' title="' + a.labelMonthSelect + '"') : o.node("div", i[u.month], a.klass.month)
        }, g = function () {
            var i = u.year, n = a.selectYears === !0 ? 5 : ~~(a.selectYears / 2);
            if (n) {
                var s = d.year, r = f.year, l = i - n, c = i + n;
                ...
                }), a.klass.selectYear, (t ? "" : "disabled") + " " + o.ariaAttr({controls: e.$node[0].id + "_table"}) + ' title="' + a.labelYearSelect + '"')
            }
        ...
        return o.node("div", (a.selectYears ? g() + v() : v() + g()) + m() + m(1), a.klass.header) + o.node("table", p + o.node("tbody", o.group({
                    ...
                    item: function (t) {
                        ...
                        return [o.group({
                            min: i * t - u.day + n + 1, max: function () {
                                return this.min + i - 1
                            }, i: 1, node: "td", item: function (t) {
                                t = e.create([u.year, u.month, t + (a.firstDay ? 1 : 0)]);
                                var i = l && l.pick == t.pick, n = c && c.pick == t.pick, s = h && e.disabled(t) || t.pick < d.pick || t.pick > f.pick, p = o.trigger(e.formats.toString, e, [a.format, t]);
                                return [o.node("div", t.date, function (e) {
                                    return e.push(u.month == t.month ? a.klass.infocus : a.klass.outfocus), r.pick == t.pick && e.push(a.klass.now), i && e.push(a.klass.selected), n && e.push(a.klass.highlighted), s && e.push(a.klass.disabled), e.join(" ")
    ...
    selectMonths: !0, selectYears: 15, onRender: function () {
        var t = $(".datepicker").pickadate("picker").get("highlight", "yyyy"), e = $(".datepicker").pickadate("picker").get("highlight", "dd"), i = $(".datepicker").pickadate("picker").get("highlight", "mmm"), n = $(".datepicker").pickadate("picker").get("highlight", "dddd");
    ...
    function C(e, n) {
        function V(t, e) {
            var a = s.offset(), r = /^touch/.test(t.type), u = a.left + m, h = a.top + m, d = (r ? t.originalEvent.touches[0] : t).pageX - u, f = (r ? t.originalEvent.touches[0] : t).pageY - h, p = Math.sqrt(d * d + f * f), g = !1;
            if (!e || !(v - y > p || p > v + y)) {
                t.preventDefault();
                var b = setTimeout(function () {
                    E.popover.addClass("clockpicker-moving")
                }, 200);
                o && s.append(E.canvas), E.setHand(d, f, !e, !0), i.off(l).on(l, function (t) {
                    t.preventDefault();
                    var e = /^touch/.test(t.type), i = (e ? t.originalEvent.touches[0] : t).pageX - u, n = (e ? t.originalEvent.touches[0] : t).pageY - h;
                    (g || i !== d || n !== f) && (g = !0, E.setHand(i, n, !1, !0))
                }), i.off(c).on(c, function (t) {
                    i.off(c), t.preventDefault();
                    var o = /^touch/.test(t.type), a = (o ? t.originalEvent.changedTouches[0] : t).pageX - u, r = (o ? t.originalEvent.changedTouches[0] : t).pageY - h;
                    (e || g) && a === d && r === f && E.setHand(a, r), "hours" === E.currentView ? E.toggleView("minutes", w / 2) : n.autoclose && (E.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                            E.done()
                        }, w / 2)), s.prepend(W), clearTimeout(b), E.popover.removeClass("clockpicker-moving"), i.off(l)
                })
            }
        }

        var a = t(x), s = a.find(".clockpicker-plate"), u = a.find(".picker__holder"), f = a.find(".clockpicker-hours"), C = a.find(".clockpicker-minutes"), S = a.find(".clockpicker-am-pm-block"), P = "INPUT" === e.prop("tagName"), T = P ? e : e.find("input"), A = t("label[for=" + T.attr("id") + "]"), E = this;
        ...
        if (n.twelvehour)for (L = 1; 13 > L; L += 1)D = F.clone(), R = L / 6 * Math.PI, z = v, D.css("font-size", "140%"), D.css({
            left: m + Math.sin(R) * z - y,
            top: m - Math.cos(R) * z - y
        }), D.html(0 === L ? "00" : L), f.append(D), D.on(r, V); else for (L = 0; 24 > L; L += 1) {
            D = F.clone(), R = L / 6 * Math.PI;
            var _ = L > 0 && 13 > L;
            z = _ ? g : v, D.css({
                left: m + Math.sin(R) * z - y,
                top: m - Math.cos(R) * z - y
            }), _ && D.css("font-size", "120%"), D.html(0 === L ? "00" : L), f.append(D), D.on(r, V)
        }
        for (L = 0; 60 > L; L += 5)D = F.clone(), R = L / 30 * Math.PI, D.css({
            left: m + Math.sin(R) * v - y,
            top: m - Math.cos(R) * v - y
        }), D.css("font-size", "140%"), D.html(d(L)), C.append(D), D.on(r, V);
        if (s.on(r, function (e) {
                0 === t(e.target).closest(".clockpicker-tick").length && V(e, !0)
            }), o) {
            var W = a.find(".clockpicker-canvas"), H = h("svg");
    ...
    var t = window.jQuery, e = t(window), i = t(document), n = "http://www.w3.org/2000/svg", o = "SVGAngle" in window && function () {
    ...
    }(), s = "ontouchstart" in window, r = "mousedown" + (s ? " touchstart" : ""), l = "mousemove.clockpicker" + (s ? " touchmove.clockpicker" : ""), c = "mouseup.clockpicker" + (s ? " touchend.clockpicker" : ""), u = navigator.vibrate ? "vibrate" : navigator.webkitVibrate ? "webkitVibrate" : null, f = 0, m = 135, v = 110, g = 80, y = 20, b = 2 * m, w = a ? 350 : 1, x = ['<div class="clockpicker picker">', '<div class="picker__holder">', '<div class="picker__frame">', '<div class="picker__wrap">', '<div class="picker__box">', '<div class="picker__date-display">', '<div class="clockpicker-display">', '<div class="clockpicker-display-column">', '<span class="clockpicker-span-hours text-primary"></span>', ":", '<span class="clockpicker-span-minutes"></span>', "</div>", '<div class="clockpicker-display-column clockpicker-display-am-pm">', '<div class="clockpicker-span-am-pm"></div>', "</div>", "</div>", "</div>", '<div class="picker__calendar-container">', '<div class="clockpicker-plate">', '<div class="clockpicker-canvas"></div>', '<div class="clockpicker-dial clockpicker-hours"></div>', '<div class="clockpicker-dial clockpicker-minutes clockpicker-dial-out"></div>', "</div>", '<div class="clockpicker-am-pm-block">', "</div>", "</div>", '<div class="picker__footer">', "</div>", "</div>", "</div>", "</div>", "</div>", "</div>"].join("");
    C.DEFAULTS = {
        "default": "",
        fromnow: 0,
        donetext: "Done",
        ...
        var o = "hours" === e, a = o ? this.hoursView : this.minutesView, s = o ? this.minutesView : this.hoursView;
        this.currentView = e, this.spanHours.toggleClass("text-primary", o), this.spanMinutes.toggleClass("text-primary", !o), s.addClass("clockpicker-dial-out"), a.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(i), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function () {
            s.css("visibility", "hidden")
        }, w), n && k(this.options.afterHourSelect)
    }, C.prototype.resetClock = function (t) {
        var e = this.currentView, i = this[e], n = "hours" === e, a = Math.PI / (n ? 6 : 30), s = i * a, r = n && i > 0 && 13 > i ? g : v, l = Math.sin(s) * r, c = -Math.cos(s) * r, u = this;
        ...
        if (h.twelvehour && (p = v), 0 > s && (s = 2 * Math.PI + s), m = Math.round(s / l), s = m * l, h.twelvehour ? r ? 0 === m && (m = 12) : (n && (m *= 5), 60 === m && (m = 0)) : r ? (12 === m && (m = 0), m = f ? 0 === m ? 12 : m : 0 === m ? 0 : m + 12) : (n && (m *= 5), 60 === m && (m = 0)), r ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : m % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== m && u && this.options.vibrate && (this.vibrateTimer || (navigator[u](10), this.vibrateTimer = setTimeout(t.proxy(function () {
                this.vibrateTimer = null
            }, this), 100))), this[this.currentView] = m, this[r ? "spanHours" : "spanMinutes"].html(d(m)), !o)return void this[r ? "hoursView" : "minutesView"].find(".clockpicker-tick").each(function () {
            var e = t(this);
        ...
        var t = this.input.prop("value"), e = d(this.hours) + ":" + d(this.minutes);
        ...
        return this.each(function () {
            var n = t(this), o = n.data("clockpicker");
            if (o) "function" == typeof o[e] && o[e].apply(o, i); else {
    ...
    var t = function (t, e, i, n) {
        ...
        o.detectFeatures(), o.features.oldIE && (o.bind = function (t, e, i, n) {
            ...
            }, r = 0; r < e.length; r++)if (o = e[r])if ("object" == typeof i && i.handleEvent) {
                if (n) {
        ...
        var c, u, h, d, f, p, m, v, g, y, b, w, x, C, k, S, P, T, A, E, M, I, O, F, L, D, R, z, _, V, W, H, N, B, j, $, q, Y, X, Q, Z, G, U, K, J, tt, et, it, nt, ot, at, st, rt, lt, ct, ut, ht = function () {
            ...
            nt && (t && (y > a.currItem.fitRatio ? kt || (hi(a.currItem, !1, !0), kt = !0) : kt && (hi(a.currItem), kt = !1)), Ot(nt, pt.x, pt.y, y))
        }, Lt = function (t) {
            ...
            if (!l.loop && e) {
                var i = d + (yt.x * vt - t) / yt.x, n = Math.round(t - ye.x);
            ...
            Wt && (o.unbind(document, "mousemove", Ht), o.addClass(t, "pswp--has_mouse"), l.mouseUsed = !0, Et("mouseUsed")), Wt = setTimeout(function () {
                Wt = null
            }, 100)
        }, Nt = function () {
            o.bind(document, "keydown", a), W.transform && o.bind(a.scrollWrap, "click", a), l.mouseUsed || o.bind(document, "mousemove", Ht), o.bind(window, "resize scroll", a), Et("bindEvents")
        }, Bt = function () {
            o.unbind(window, "resize", a), o.unbind(window, "scroll", g.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ht), W.transform && o.unbind(a.scrollWrap, "click", a), Y && o.unbind(window, m, a), Et("unbindEvents")
        }, jt = function (t, e) {
            ...
            I = "left", o.addClass(t, "pswp--ie"), Dt = function (t, e) {
                ...
                if (nt) {
                    var t = nt, e = a.currItem, i = e.fitRatio > 1 ? 1 : e.fitRatio, n = i * e.w, o = i * e.h;
            ...
            t && (Z || Q || ot || $) && (t.preventDefault(), t.stopPropagation())
        }, Gt = function () {
            a.setScrollOffset(0, o.getScrollY())
        }, Ut = {}, Kt = 0, Jt = function (t) {
            Ut[t] && (Ut[t].raf && D(Ut[t].raf), Kt--, delete Ut[t])
        }, te = function (t) {
            ...
            shout: Et, listen: At, viewportSize: mt, options: l, isMainScrollAnimating: function () {
                return ot
                ...
                gt.x = t, V = gt.y = e, Et("updateScrollOffset", gt)
            }, applyZoomPan: function (t, e, i, n) {
                pt.x = e, pt.y = i, y = t, Ft(n)
            }, init: function () {
                if (!c && !u) {
                    var i;
                    a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), R = t.className, c = !0, W = o.detectFeatures(), L = W.raf, D = W.caf, I = W.transform, _ = W.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), f = a.container.style, a.itemHolders = S = [{
                        ...
                        wrap: 0,
                        index: -1
                    }], S[0].el.style.display = S[2].el.style.display = "none", Xt(), g = {
                        resize: a.updateSize,
                        scroll: Gt,
                        keydown: Qt,
                        click: Zt
                    ...
                    _ || o.bind(a.scrollWrap, v, a), At("initialZoomInEnd", function () {
                        a.setContent(S[0], d - 1), a.setContent(S[2], d + 1), S[0].el.style.display = S[2].el.style.display = "block", l.focus && t.focus(), Nt()
                    }), a.setContent(S[1], d), a.updateCurrItem(), Et("afterInit"), wt || (C = setInterval(function () {
                        Kt || Y || J || y !== a.currItem.initialZoomLevel || a.updateSize()
                    }, 1e3)), o.addClass(t, "pswp--visible")
                }
            }, close: function () {
                c && (c = !1, u = !0, Et("close"), Bt(), ei(a.currItem, null, !0, a.destroy))
            }, destroy: function () {
                Et("destroy"), Qe && clearTimeout(Qe), t.setAttribute("aria-hidden", "true"), t.className = R, C && clearInterval(C), o.unbind(a.scrollWrap, v, a), o.unbind(window, "scroll", a), Se(), ee(), Tt = null
            }, panTo: function (t, e, i) {
                i || (t > it.min.x ? t = it.min.x : t < it.max.x && (t = it.max.x), e > it.min.y ? e = it.min.y : e < it.max.y && (e = it.max.y)), pt.x = t, pt.y = e, Ft()
            }, handleEvent: function (t) {
                t = t || window.event, g[t.type] && g[t.type](t)
            }, goTo: function (t) {
                t = Pt(t);
                var e = t - d;
                bt = e, d = t, a.currItem = Ke(d), vt -= e, Rt(yt.x * vt), ee(), ot = !1, a.updateCurrItem()
            }, next: function () {
                a.goTo(d + 1)
            }, prev: function () {
                a.goTo(d - 1)
                ...
                it = a.currItem.bounds, b = y = a.currItem.initialZoomLevel, pt.x = it.center.x, pt.y = it.center.y, t && Et("afterChange")
            }, invalidateCurrItems: function () {
                k = !0;
                for (var t = 0; r > t; t++)S[t].item && (S[t].item.needsUpdate = !0)
            }, updateCurrItem: function (t) {
                if (0 !== bt) {
                    var e, i = Math.abs(bt);
                    if (!(t && 2 > i)) {
                        a.currItem = Ke(d), kt = !1, Et("beforeChange", bt), i >= r && (p += bt + (bt > 0 ? -r : r), i = r);
                        ...
                        bt = 0, a.updateCurrZoomItem(), P = d, Et("afterChange")
                    }
                }
                ...
                b = y = a.currItem.initialZoomLevel, it = a.currItem.bounds, it && (pt.x = it.center.x, pt.y = it.center.y, Ft(!0)), Et("resize")
            }, zoomTo: function (t, e, i, n, a) {
                e && (b = y, be.x = Math.abs(e.x) - pt.x, be.y = Math.abs(e.y) - pt.y, _t(ft, pt));
                var s = jt(t, !1), r = {};
                Yt("x", s, r, t), Yt("y", s, r, t);
                var l = y, c = {x: pt.x, y: pt.y};
                Vt(r);
                var u = function (e) {
                    1 === e ? (y = t, pt.x = r.x, pt.y = r.y) : (y = (t - l) * e + l, pt.x = (r.x - c.x) * e + c.x, pt.y = (r.y - c.y) * e + c.y), a && a(e), Ft(1 === e)
                };
            ...
            return O ? (ut = 0, he.forEach(function (t) {
                    0 === ut ? ze[0] = t : 1 === ut && (ze[1] = t), ut++
                })) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (ze[0] = Ie(t.touches[0], De), t.touches.length > 1 && (ze[1] = Ie(t.touches[1], Re))) : (De.x = t.pageX, De.y = t.pageY, De.id = "", ze[0] = De), ze
        }, Ve = function (t, e) {
            ...
            if (!("mousedown" === t.type && t.button > 0)) {
                ...
                if (!q || "mousedown" !== t.type) {
                    ...
                    var i = _e(t), n = i.length;
                    K = null, ee(), Y && 1 !== n || (Y = st = !0, o.bind(window, m, a), j = ct = rt = $ = U = Z = X = Q = !1, at = null, Et("firstTouchStart", i), _t(ft, pt), dt.x = dt.y = 0, _t(ce, i[0]), _t(ue, ce), de.x = yt.x * vt, fe = [{
                        x: ce.x,
                        y: ce.y
                    }], N = H = Mt(), jt(y, !0), Se(), Pe()), !J && n > 1 && !ot && !U && (b = y, Q = !1, J = X = !0, dt.y = dt.x = 0, _t(ft, pt), _t(se, i[0]), _t(re, i[1]), Oe(se, re, we), be.x = Math.abs(we.x) - pt.x, be.y = Math.abs(we.y) - pt.y, tt = et = ke(se, re))
                }
            }
        }, He = function (t) {
            ...
            if (Y) {
                var n = _e(t);
                if (at || Z || J) K = n; else if (ye.x !== yt.x * vt) at = "h"; else {
            ...
            if (K) {
                var t = K.length;
                if (0 !== t)if (_t(se, K[0]), le.x = se.x - ce.x, le.y = se.y - ce.y, J && t > 1) {
                    if (ce.x = se.x, ce.y = se.y, !le.x && !le.y && xe(K[1], re))return;
                    _t(re, K[1]), Q || (Q = !0, Et("zoomGestureStarted"));
                    var e = ke(se, re), i = Ye(e);
                    i > a.currItem.initialZoomLevel + a.currItem.initialZoomLevel / 15 && (ct = !0);
                    var n = 1, o = $t(), s = qt();
                    if (o > i)if (l.pinchToClose && !ct && b <= a.currItem.initialZoomLevel) {
                        var r = o - i, c = 1 - r / (o / 1.2);
                        It(c), Et("onPinchClose", c), rt = !0
                    } else n = (o - i) / o, n > 1 && (n = 1), i = o - n * (o / 3); else i > s && (n = (i - s) / (6 * o), n > 1 && (n = 1), i = s + n * o);
                    0 > n && (n = 0), tt = e, Oe(se, re, ve), dt.x += ve.x - we.x, dt.y += ve.y - we.y, _t(we, ve), pt.x = zt("x", i), pt.y = zt("y", i), j = i > y, y = i, Ft()
                } else {
                    if (!at)return;
            ...
            if (O) {
                ...
                if (i > -1)if (e = he.splice(i, 1)[0], navigator.pointerEnabled) e.type = t.pointerType || "mouse"; else {
            ...
            1 === c && _t(ue, r[0]), 0 !== c || at || ot || (e || ("mouseup" === t.type ? e = {
                    x: t.pageX,
                    y: t.pageY,
                    type: "mouse"
            ...
            var u = -1;
            if (0 === c && (Y = !1, o.unbind(window, m, a), Se(), J ? u = 0 : -1 !== ge && (u = Mt() - ge)), ge = 1 === c ? Mt() : -1, s = -1 !== u && 150 > u ? "zoom" : "swipe", J && 2 > c && (J = !1, 1 === c && (s = "zoomPointerUp"), Et("zoomGestureEnded")), K = null, Z || Q || ot || $)if (ee(), B || (B = je()), B.calculateSwipeSpeed("x"), $) {
                var h = Le();
                if (h < l.verticalDragRange) a.close(); else {
                    var d = pt.y, f = lt;
                    ie("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (t) {
                        pt.y = (a.currItem.initialPosition.y - d) * t + d, It((1 - f) * t + f), Ft()
                    }), Et("onVerticalDrag", 1)
                }
            } else {
                if ((U || ot) && 0 === c) {
            ...
            return i || h > ye.x == e.lastFlickSpeed.x > 0 ? (u = Math.abs(e.lastFlickSpeed.x) > 0 ? f / Math.abs(e.lastFlickSpeed.x) : 333, u = Math.min(u, 400), u = Math.max(u, 250)) : u = 333, me === d && (i = !1), ot = !0, Et("mainScrollAnimStart"), ie("mainScroll", ye.x, h, u, o.easing.cubic.out, Rt, function () {
                ee(), ot = !1, me = -1, (i || me !== d) && a.updateCurrItem(), Et("mainScrollAnimComplete")
            ...
            e > y ? t = e : y > i && (t = i);
            var n, s = 1, r = lt;
            return rt && !j && !ct && e > y ? (a.close(), !0) : (rt && (n = function (t) {
                    It((s - r) * t + r)
        ...
        var Qe, Ze, Ge, Ue, Ke, Je, ti, ei = function (e, i, n, s) {
            ...
            var c = n ? l.hideAnimationDuration : l.showAnimationDuration, u = function () {
                Jt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (It(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), Et("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), Ue = !1
            };
            if (!c || !r || void 0 === r.x)return Et("initialZoom" + (n ? "Out" : "In")), y = e.initialZoomLevel, _t(pt, e.initialPosition), Ft(), t.style.opacity = n ? 0 : 1, It(1), void(c ? setTimeout(function () {
                    u()
                }, c) : u());
            var f = function () {
                var i = h, s = !a.currItem.src || a.currItem.loadError || l.showHideOpacity;
                e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (y = r.w / e.w, pt.x = r.x, pt.y = r.y - z, a[s ? "template" : "bg"].style.opacity = .001, Ft()), te("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                        o.addClass(t, "pswp--animate_opacity")
                    }, 30)), Qe = setTimeout(function () {
                    if (Et("initialZoom" + (n ? "Out" : "In")), n) {
                        var a = r.w / e.w, l = {x: pt.x, y: pt.y}, h = y, d = lt, f = function (e) {
                            1 === e ? (y = a, pt.x = r.x, pt.y = r.y - V) : (y = (a - h) * e + h, pt.x = (r.x - l.x) * e + l.x, pt.y = (r.y - V - l.y) * e + l.y), Ft(), s ? t.style.opacity = 1 - e : It(d - e * d)
                        };
                        i ? ie("initialZoom", 0, 1, c, o.easing.cubic.out, f, u) : (f(1), Qe = setTimeout(u, c + 20))
                    } else y = e.initialZoomLevel, _t(pt, e.initialPosition), Ft(), It(1), s ? t.style.opacity = 1 : It(1), Qe = setTimeout(u, c + 20)
                }, n ? 25 : 90)
            };
            f()
        }, ii = {}, ni = [], oi = {
            ...
            if (t.src && !t.loadError) {
                ...
                if (n && (t.vGap || (t.vGap = {
                    ...
                    var o = ii.x / t.w, a = ii.y / t.h;
                    t.fitRatio = a > o ? o : a;
                    var s = l.scaleMode;
                    "orig" === s ? i = 1 : "fit" === s && (i = t.fitRatio), i > 1 && (i = 1), t.initialZoomLevel = i, t.bounds || (t.bounds = ai())
                }
                if (!i)return;
            ...
            e.loadError || n && (e.imageAppended = !0, hi(e, n, e === a.currItem && kt), i.appendChild(n), s && setTimeout(function () {
        ...
        St("Controller", {
            publicMethods: {
                lazyLoadItem: function (t) {
                    ...
                    o.extend(l, oi, !0), a.items = Ze = i, Ke = a.getItemAt, Je = l.getNumItemsFn, ti = l.loop, Je() < 3 && (l.loop = !1), At("beforeChange", function (t) {
                        var e, i = l.preload, n = null === t ? !0 : t >= 0, o = Math.min(i[0], Je()), s = Math.min(i[1], Je());
                        for (e = 1; (n ? s : o) >= e; e++)a.lazyLoadItem(d + e);
                        for (e = 1; (n ? o : s) >= e; e++)a.lazyLoadItem(d - e)
                    }), At("initialLayout", function () {
                        a.currItem.initialLayout = l.getThumbBoundsFn && l.getThumbBoundsFn(d)
                    }), At("mainScrollAnimComplete", di), At("initialZoomInEnd", di), At("destroy", function () {
                    ...
                    if (!s.src && s.html && (s.html.tagName ? r.appendChild(s.html) : r.innerHTML = s.html), ui(s), ri(s, mt), !s.src || s.loadError || s.loaded) s.src && !s.loadError && (n = o.createEl("pswp__img", "img"),
                        n.style.opacity = 1, n.src = s.src, hi(s, n), li(e, s, r, n, !0)); else {
                        if (s.loadComplete = function (i) {
                                if (c) {
                                    if (t && t.index === e) {
                                        if (ui(i, !0))return i.loadComplete = i.img = null, ri(i, mt), Lt(i), void(t.index === d && a.updateCurrZoomItem());
                                        i.imageAppended ? !Ue && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : W.transform && (ot || Ue) ? ni.push({
                                                    item: i,
                                                    baseDiv: r,
                                                    img: i.img,
                                                    index: e,
                        ...
                        s.loading || ci(s), a.allowProgressiveImg() && (!Ge && W.transform ? ni.push({
                                item: s,
                                baseDiv: r,
                                img: s.img,
                                index: e,
        ...
        St("Tap", {
            publicMethods: {
                initTap: function () {
                    At("firstTouchStart", a.onTapStart), At("touchRelease", a.onTapRelease), At("destroy", function () {
                        pi = {}, fi = null
                    })
                    ...
                    if (e && !Z && !X && !Kt) {
                        ...
                        _t(pi, i), fi = setTimeout(function () {
                            mi(t, e), fi = null
                        }, 300)
                    }
                }
        ...
        St("DesktopZoom", {
            publicMethods: {
                initDesktopZoom: function () {
                    ...
                    var n, s = function () {
                        a.mouseZoomedIn && (o.removeClass(t, "pswp--zoomed-in"), a.mouseZoomedIn = !1), 1 > y ? o.addClass(t, "pswp--zoom-allowed") : o.removeClass(t, "pswp--zoom-allowed"), r()
                    }, r = function () {
                    ...
                    e = e || {x: mt.x / 2 + gt.x, y: mt.y / 2 + gt.y};
        ...
        var gi, yi, bi, wi, xi, Ci, ki, Si, Pi, Ti, Ai, Ei, Mi = {history: !0, galleryUID: 1}, Ii = function () {
            ...
            if (l.galleryPIDs) {
                var a = e.pid;
                for (e.pid = 0, i = 0; i < Ze.length; i++)if (Ze[i].pid === a) {
                    e.pid = i;
                    break
                }
            ...
            Ei ? "#" + i !== window.location.hash && history[Si ? "replaceState" : "pushState"]("", document.title, n) : Si ? Ai.replace(n) : Ai.hash = i, Si = !0, yi = setTimeout(function () {
                wi = !1
            }, 60)
        };
        St("History", {
            publicMethods: {
                initHistory: function () {
                    if (o.extend(l, Mi, !0), l.history) {
                        Ai = window.location, Ti = !1, Pi = !1, Si = !1, ki = Ii(), Ei = "pushState" in history, ki.indexOf("gid=") > -1 && (ki = ki.split("&gid=")[0], ki = ki.split("?gid=")[0]), At("afterChange", a.updateURL), At("unbindEvents", function () {
                            o.unbind(window, "hashchange", a.onHashChange)
                        });
                        var t = function () {
                            Ci = !0, Pi || (Ti ? history.back() : ki ? Ai.hash = ki : Ei ? history.pushState("", document.title, Ai.pathname + Ai.search) : Ai.hash = ""), Oi()
                        };
                        At("unbindEvents", function () {
                            h && t()
                        }), At("destroy", function () {
                    ...
                    return Ii() === ki ? (Pi = !0, void a.close()) : void(wi || (xi = !0, a.goTo(Fi().pid), xi = !1))
                }, updateURL: function () {
                    Oi(), xi || (Si ? gi = setTimeout(Li, 800) : Li())
                }
            }
        }), o.extend(a, ne)
    };
    ...
    var t = function (t, e) {
        var i, n, o, a, s, r, l, c, u, h, d, f, p, m, v, g, y, b, w, x = this, C = !1, k = !0, S = !0, P = {
            ...
            if (A()) {
                var s = v.barsSize;
                if (v.captionEl && "auto" === s.bottom)if (a || (a = e.createEl("pswp__caption pswp__caption--fake"), a.appendChild(e.createEl("pswp__caption__center")), n.insertBefore(a, o), e.addClass(n, "pswp__ui--fit")), v.addCaptionHTMLFn(t, a, !0)) {
            ...
            v.timeToIdle && h("mouseUsed", function () {
                e.bind(document, "mousemove", z), e.bind(document, "mouseout", _), b = setInterval(function () {
                    R++, 2 === R && x.setIdle(!0)
                }, v.timeToIdle / 2)
            })
        }, j = function () {
        ...
        x.init = function () {
            e.extend(t.options, P, !0), v = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), h = t.listen, j(), h("beforeChange", x.update), h("doubleTap", function (e) {
                ...
                S || O(), b && clearInterval(b), e.unbind(document, "mouseout", _), e.unbind(document, "mousemove", z), e.unbind(n, "pswpTap click", T), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (v.hideAnimationDuration = 0, i.exit()), i = null)
            }), h("destroy", function () {
            ...
            }), h("parseVerticalMargin", N), q(), v.shareEl && r && l && (S = !0), M(), B(), V(), W()
        }, x.setIdle = function (t) {
            u = t, E(n, "ui--idle", t)
        }, x.update = function () {
            k && t.currItem ? (x.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(t.currItem, o), E(o, "caption--empty", !t.currItem.title)), C = !0) : C = !1, S || O(), M()
            ...
            k = !0, C || x.update(), e.removeClass(n, "pswp__ui--hidden")
...
var initPhotoSwipeFromDOM = function (t) {
    for (var e = function (t) {
        for (var o, a, s, r, e = t.childNodes, i = e.length, n = [], l = 0; i > l; l++)o = e[l], 1 === o.nodeType && (a = o.children[0], s = a.getAttribute("data-size").split("x"), r = {
        ...
        if (n) {
            for (var c, o = n.parentNode, s = n.parentNode.childNodes, r = s.length, l = 0, u = 0; r > u; u++)if (1 === s[u].nodeType) {
                if (s[u] === n) {
                    c = l;
                    break
                }
        ...
        if (l = e(i), r = {
                galleryUID: i.getAttribute("data-pswp-uid"), getThumbBoundsFn: function (t) {
        ...
        isNaN(r.index) || (n && (r.showAnimationDuration = 0), s = new PhotoSwipe(a, PhotoSwipeUI_Default, l, r), s.init())
    }, s = document.querySelectorAll(t), r = 0, l = s.length; l > r; r++)s[r].setAttribute("data-pswp-uid", r + 1), s[r].onclick = n;
    var c = o();
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
    t.fn.sticky = function (e) {
        ...
        var i = {topSpacing: 0, zIndex: "", stopper: ".sticky-stopper"}, n = t.extend({}, i, e), a = o(), r = s();
        return this.each(function () {
            function f() {
                var n = d.scrollTop();
                if (r && "string" == typeof h)var o = t(h).offset().top, f = o - i - s; else if (r && "number" == typeof h)var f = h;
                if (n > c) {
                    if (e.after(u).css({position: "fixed", top: s}), a && e.css({zIndex: l}), r && n > f) {
                        var p = f - n + s;
                        e.css({top: p})
                    }
                } else e.css({position: "static", top: null, left: null}), u.remove()
            }

            var e = t(this), i = e.outerHeight(), o = e.outerWidth(), s = n.topSpacing, l = n.zIndex, c = e.offset().top - s, u = t("<div></div>").width(o).height(i).addClass("sticky-placeholder"), h = n.stopper, d = t(window);
            d.bind("scroll", f)
        })
    }
}(jQuery);